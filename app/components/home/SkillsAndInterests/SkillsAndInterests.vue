<template>
  <section ref="sectionRef" class="relative w-screen min-h-[max(2000px,220svh)] sm:min-h-[max(1700px,180vh)]">
    <div class="sticky top-0 flex min-h-[max(2000px,220svh)] sm:min-h-[max(1700px,180vh)] flex-col">
      ...
      <div
        class="relative flex-1 min-h-[max(2000px,220svh)] sm:min-h-[max(1700px,180vh)] flex items-center justify-start"
      >
