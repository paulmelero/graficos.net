...
const skillsAndInterestsDirectlyRelatedTo = {
...
const skillsAndInterestsIndirectlyRelatedToArtAndNature = ['Traveling', 'Gardening', 'Plants'] as const
const skillsAndInterestsIndirectlyRelatedToArtAndTechnology = ['Maths', 'Game Development'] as const
const skillsAndInterestsIndirectlyRelatedToNatureAndTechnology = [
  'Physics',
  'Astronomy',
  'Applied Mathematics',
] as const
const skillsAndInterestsIndirectlyRelatedToAll = ['Cooking', 'Randomness'] as const

const skillsAndInterestsPerCategory = {
  [RELATED_TO.ART]: [
...
const isSkillOrInterestActive = (skillOrInterest: string) => {
  ...
  const relatedSkillsAndInterests =
    skillsAndInterestsPerCategory[activeTopic.value as keyof typeof skillsAndInterestsPerCategory]
