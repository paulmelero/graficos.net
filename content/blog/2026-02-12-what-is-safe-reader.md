...
## Why would you care about reading articles without accepting cookies?
...
Your privacy gets compromised when you accept the cookies since your personal data gets shared with third parties, and you get tracked across the web.
...
- I also use `DOMPurify` to sanitize the HTML content, to strip out JS-related tags and attributes, and to make sure that the content is safe to render in the app.
- `linkedom` so the HTML can be parsed and manipulated on the server side.
...
Have you used the app and want to share your feedback? You can do it in the [GitHub repository](https://github.com/paulmelero/safe-reader) and I will be happy to hear your thoughts and suggestions for improvement.
